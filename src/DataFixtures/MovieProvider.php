...
class MovieProvider extends \Faker\Provider\Base
{
    public function getMovie()
    {
        $movie_array = array(
            ...
            array('summary'=> $this->generator->paragraph(2),'synopsis'=> $this->generator->realText(500), 'type'=>'Série','title'=>'Narco','release_date'=>$this->generator->dateTime(),'duration'=>mt_rand(60,220),'poster'=>'https://picsum.photos/id/'.$this->unique()->randomNumber(2).'/200/300','rating'=>$this->randomFloat(1,1,5)),
        );
